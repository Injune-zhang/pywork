...
(function($, undefined) {
  ...
  $.widget("ech.multiselect", {
    ...
    _create: function() {
      ...
      var button = (this.button = $('<button type="button" style="background-color:#FFFFFF;color:#666666;font-family:微软雅黑;font-size: 1em;"><span class="ui-icon ui-icon-triangle-1-s"></span></button>'))
	...
	MyTexts:function(){
		return this.options.multiTexts;
	} ,
    ...
    update: function() {
      ...
      if(numChecked === 0) {
        ...
        o.multiValues = $checked.map(function () {return $(this).val(); }).get().join('+');
        o.multiTexts = value;
      }
